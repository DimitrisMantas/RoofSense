...
from roofsense.inference.tile.dataset import InferenceDataset
...
class InferenceEngine:
    def __init__(
        ...
        self.dataset = InferenceDataset(data_root)
        ...
        self.model: roofsense.training.task.TrainingTask = (
...
if __name__ == "__main__":
    engine = InferenceEngine(
        ...
        model_ckpt=r"C:\Documents\RoofSense\logs\optimization_random_search_round_3_tpe\version_20\ckpts\last.ckpt",
    )
    engine.run(r"C:\Documents\RoofSense\dataset\infer\10-280-560.map.tpe.stride16.tif")
